...
// Función compartida para actualizar la cotización
...
// Handler para POST (uso interno desde el dashboard)
...
// Handler para GET (para servicios de cron que solo soportan GET)
